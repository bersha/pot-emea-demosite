...
## Environments
- Preview: https://main--pot-emea-demosite--bersha.aem.page/
- Live: https://main--pot-emea-demosite--bersha.aem.live/
...
1. Open the `pot-emea-demosite` directory in your favorite IDE and start coding :)
